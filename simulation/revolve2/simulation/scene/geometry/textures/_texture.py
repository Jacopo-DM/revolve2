...
class Texture:
    ...
    If no reference is given, the base_color will be used on the Object.
    """
    ...
    """Allows you to set how often a texture should be repeated across the x
    and y axis (Only for 2d maps)."""
    size: tuple[int, int] = field(default=(100, 100))
    """Allows to set the size of a texture.

    The higher the size, the higher the resolution
    """
