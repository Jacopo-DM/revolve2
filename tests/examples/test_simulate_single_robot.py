...
def test_simulate_single_robot(mocker: Mock) -> None:
    """
    Test 000_simulate_single_robot example can complete.

    :param mocker: The mock object.
    """
    exp_dir = os.path.join(EXAMPLES_DIR, "000_simulate_single_robot")
