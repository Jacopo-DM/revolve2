...
def main() -> None:
    ...
    A simulator can run multiple scene in parallel, and as such is very useful for simulating populations of robots..
    ...
    Note that for optimal performance do not use more simulators than cpu cores available on your machine.
    """
